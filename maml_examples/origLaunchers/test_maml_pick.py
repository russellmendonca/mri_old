...
initial_params_file = '/home/russellm/maml_rl/data/local/sawyer-pick/trpomaml1_fbs20_mbs20_flr_0.1metalr_0.01_step11/itr_900.pkl'
...
for goal in range(10,20):
    ...
    run_experiment_lite(
        ...
        # will be used
        seed=4,
        exp_prefix='sawyerPick-20X20-metaTest-trainSet',
